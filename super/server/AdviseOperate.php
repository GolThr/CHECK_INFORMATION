...
if($op == "get"){
    ...
    $sql = "SELECT * FROM d_advises f INNER JOIN d_users u ON f.uuid=u.uuid ORDER BY " . $s . " " . $m;
    ...
    $sql = "UPDATE d_advises SET solved='1',sol_time='$today' WHERE id='$id'";
    $obj = mysqli_query($link, $sql);
    if($obj){
        $flag = 1;
    }
    ...
    $sql = "SELECT * FROM d_advises f INNER JOIN d_users u ON f.uuid=u.uuid 
